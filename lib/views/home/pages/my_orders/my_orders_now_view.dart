...
import 'my_orders_finished_view.dart';

class MyOrdersNowPage extends StatefulWidget {
  const MyOrdersNowPage({super.key});

  @override
  State<MyOrdersNowPage> createState() => _MyOrderspageState();
}

class _MyOrderspageState extends State<MyOrdersNowPage> {
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: FilledButton(
                            ...
                            onPressed: () {
                              navigateTo(MyOrdersFinishedPage());
                            },
                            child: Text(
                              "المنتهية",
                              style: TextStyle(
